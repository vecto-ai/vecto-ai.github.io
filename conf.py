...
BLOG_AUTHOR = "vecto community"  # (translatable)
BLOG_TITLE = "vecto"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://vecto.space/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://vecto.space/"
BLOG_EMAIL = "alex@blackbird.pw"
BLOG_DESCRIPTION = "vector space models made easy"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    (
        (
            (
                ('http://vecto.readthedocs.io/en/docs/', 'API reference'),
                ('http://vecto.readthedocs.io/en/docs/tutorial/index.html', 'Tutorial')
            ),
            'Docs'
        ),
        (
...
#                ('/Jupyter', 'Jupyter notebooks'),
        ...
        (
            (
                ('/data/', 'Corpora'),
                ('/data/', 'Pre-trained emmbeddings'),
                ('/data/', 'Tasks'),
                ('/data/', 'Datasets'),
                ('/data/', 'Share your work and increase its visibility')
            ),
            'Models & Data Library '
        ),
